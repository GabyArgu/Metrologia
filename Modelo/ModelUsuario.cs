...
namespace Modelo
{
    public class ModelUsuario
    {
        ...
        {
            DataTable retorno;
            string query = "SELECT E.CodigoEmpleado AS Código,E.Usuario,E.Nombre,E.Apellido,E.Correo,E.Telefono,CE.Nombre AS Cargo, EE.Nombre AS Estado FROM Empleado E, EstadoEmpleado EE, CargoEmpleado CE WHERE E.CodigoEstadoEm=EE.CodigoEstadoEm AND E.CodigoCargo=CE.CodigoCargo";
            try
            {
                SqlCommand cmdselect = new SqlCommand(string.Format(query), Conexion.getConnect());
                SqlDataAdapter adp = new SqlDataAdapter(cmdselect);
        ...
        {
            DataTable retorno;
            string query = "SELECT * FROM CargarEmpleados WHERE Usuario LIKE @Busqueda OR Nombre LIKE @Busqueda OR Apellido LIKE @Busqueda OR Estado LIKE @Busqueda";
            try
            {
